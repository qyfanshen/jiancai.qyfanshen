...
> Cloud System for Building Materials

> 🚀 **[Live Demo](https://jiancai.qyfanshen.com)** · 📚 **[Docs](docs/)** · 📋 **[Quick Start](docs/QUICKSTART.md)** · 🐛 **[Report Bug](https://github.com/qyfanshen/jiancai.qyfanshen/issues)** · ⭐ **[Star](https://github.com/qyfanshen/jiancai.qyfanshen)**

![preview](screenshots/preview.png)
<p align="center">
  <a href="https://github.com/qyfanshen/jiancai.qyfanshen"><img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="License"></a>
  <a href="https://github.com/qyfanshen/jiancai.qyfanshen/actions"><img src="https://img.shields.io/github/actions/workflow/status/qyfanshen/jiancai.qyfanshen/ci.yml?branch=master&label=CI" alt="CI"></a>
  <a href="https://img.shields.io/github/languages/code-size/qyfanshen/jiancai.qyfanshen"><img src="https://img.shields.io/github/languages/code-size/qyfanshen/jiancai.qyfanshen" alt="Code size"></a>
  <a href="https://github.com/qyfanshen/jiancai.qyfanshen/issues"><img src="https://img.shields.io/github/issues/qyfanshen/jiancai.qyfanshen" alt="Issues"></a>
  <a href="https://github.com/qyfanshen/jiancai.qyfanshen/stargazers"><img src="https://img.shields.io/github/stars/qyfanshen/jiancai.qyfanshen?style=social" alt="Stars"></a>
</p>
...
- **🧱 Material sourcing** — Publish and browse building-material supply & demand.
- **🤝 Chamber collaboration** — Member showcase, events and cooperation within the chamber.
- **📞 Contact & onboarding** — Clear entry points for suppliers, buyers and new members.

## Features

### Core Features
- Industry-specific landing for building materials suppliers
...
```bash
git clone https://gitee.com/qyfanshen/jiancaixitong.git
cd jiancai.qyfanshen.com
...
server {
    listen 80;
    server_name jiancai.qyfanshen.com;
...
server {
    ...
    ssl_certificate     /etc/nginx/ssl/jiancai-cloud.crt;
    ssl_certificate_key /etc/nginx/ssl/jiancai-cloud.key;

    root /var/www/jiancai.qyfanshen.com;
...
- [ ] HTTPS 已生效（浏览器锁图标）
- [ ] `https://jiancai.qyfanshen.com/.env` 返回 404
...
- Domain: https://jiancai.qyfanshen.com
